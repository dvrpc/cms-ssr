          ...
          <div className="mh3 w-100 flex justify-between">
            <div className="w-50 flex flex-wrap justify-between items-end">
              ...
              <p className="mt5 f6">
                ...
                statutes and regulations in all programs and activities. DVRPC's
                website, www.dvrpc.org, may be translated into multiple
                languages. Publications and other public documents can be made
                available in alternative languages and formats, if requested.
                ...
                file a formal complaint. Any such complaint may be in writing
                and filed with DVRPC's Title VI Compliance Manager and/or the
                appropriate state or federal agency within 180 days of the
                alleged discriminatory occurrence. For more information on
                DVRPC's Title VI program or to obtain a Title VI Complaint Form,
                please visit: www.dvrpc.org/GetInvolved/TitleVI, call (215)
                592-1800, or email public_affairs@dvrpc.org.
              </p>
            </div>
