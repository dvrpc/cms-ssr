...
const AppCard = ({ node }) => {
  ...
  return (
    <div
      className="mx-1 flex min-w-[90%] snap-center break-inside-avoid flex-col bg-white p-[0.25em] md:mx-2 md:min-w-[375px]"
      key={id}
    >
      <a href={url.uri}>
        <div className="relative overflow-hidden">
          ...
          />
          <div
            className="absolute top-0 right-0 bottom-0 left-0 flex h-full w-full flex-col items-center justify-center overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-[85%]"
            style={{
