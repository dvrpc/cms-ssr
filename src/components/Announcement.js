...
const Announcement = (props) => (
  <div className="h-40 md:mb-[22px] md:h-32 md:w-5/6 min-[1024px]:mb-[36px]">
    {!props.relationships && (
      <h4 className="m0 mb-[3px] font-bold md:text-[20px] md:leading-[25px]">
    ...
    {props.relationships && (
      <>
        <div className="flex">
          <img
            className="mr-[12px] h-16 w-16 border border-[#C2C2C2] object-cover p-[0.05rem] md:h-20 md:w-20"
            src={props.relationships.field_image.url}
          />
          <div className="mb-auto md:ml-2">
            <h4 className="m-0 mb-[3px] text-[18px] font-bold leading-tight md:text-[20px] md:leading-[25px]">
              <a className="underline" href={props.path.alias}>
                {props.title}
              </a>
            </h4>
